                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="basic-datatable" class="table dt-responsive nowrap">
                                            ...
                                            <tbody>
                                            <c:forEach var="bakery" items="${listBakery}">
                                            <tr>
                                                <td><c:out value="${bakery.id}"/></td>
                                                <td><c:out value="${bakery.bakeryName}"/></td>
                                                <td><c:out value="${bakery.price}"/></td>
                                                <td><c:out value="${bakery.quantity}"/></td>
                                                <td><c:out value="${bakery.description}"/></td>
                                                <td><a type="button" href="/admin?action=updatebakery&id=${bakery.id}" class="btn btn-info btn-rounded waves-effect waves-light">Edit</a></td>
                                                <td><a type="button" class="btn btn-danger btn-rounded waves-effect waves-light">Remove</a></td>
                                                <td><a type="button" class="btn btn-purple btn-rounded waves-effect waves-light">Create Order</a></td>
                                            </tr>
                                            </c:forEach>
                                            <%--<tr>--%>
<%--                                                    <td>1</td>--%>
<%--                                                    <td><img src="/assets/img/TH Bakery (1).png" alt="" width="50" height="50"></td>--%>
<%--                                                    <td>Banh ngot</td>--%>
<%--                                                    <td>9000</td>--%>
<%--                                                    <td>ngon</td>--%>
<%--                                                    <td><a type="button" class="btn btn-info btn-rounded waves-effect waves-light">Edit</a></td>--%>
<%--                                                    <td><a type="button" class="btn btn-danger btn-rounded waves-effect waves-light">Block</a></td>--%>
<%--                                                    <td><button type="button" class="btn btn-purple btn-rounded waves-effect waves-light">Create Order</button></td>--%>
<%--                                                </tr>--%>
<%--                                                <tr>--%>
<%--                                                    <td>2</td>--%>
<%--                                                    <td><img src="/assets/img/TH Bakery (1).png" alt="" width="50" height="50"></td>--%>
...
<%--                                                    <td>9000</td>--%>
<%--                                                    <td>ngon</td>--%>
<%--                                                    <td><button type="button" class="btn btn-info btn-rounded waves-effect waves-light">Edit</button></td>--%>
<%--                                                    <td><button type="button" class="btn btn-danger btn-rounded waves-effect waves-light">Block</button></td>--%>
<%--                                                    <td><button type="button" class="btn btn-purple btn-rounded waves-effect waves-light">Create Order</button></td>--%>
<%--                                                </tr>--%>
<%--                                                <tr>--%>
<%--                                                    <td>3</td>--%>
