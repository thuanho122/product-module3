                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Form New Staff</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Create New Staff</h4>
                                        <p class="sub-header">
                                            Fill in the boxes below to create a new staff
                                        </p>

                                        <div class="row">
                                            <div class="col-md-6">
                                                <form action="/admin?action=addnewuser" method="post">
                                                    <div class="form-group">
                                                        <label>Full Name</label>
                                                        <input type="text" name="fullName" class="form-control" data-toggle="input-mask" placeholder="Ho Thuan">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Email</label>
                                                        <input type="text" name="email" class="form-control" data-toggle="input-mask" placeholder="thuan@gmail.com">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Phone</label>
                                                        <input type="text" name="phone" class="form-control" data-toggle="input-mask" placeholder="034440987">
                                                    </div>
                                            ...
                                            <div class="col-md-6">  
                                                <div class="form-group">
                                                    <label>Age</label>
                                                    <input type="number" name="age" min="18" class="form-control" data-toggle="input-mask" placeholder="23">
                                                </div>
                                                <div class="form-group">
                                                    <label>Address</label>
                                                    <input type="text"  name="address" class="form-control" data-toggle="input-mask" placeholder="30 Tran Phu Thua Thien Hue">
                                                </div>
                                                <div class="form-group">
                                                    <label>Password</label>
                                                    <input type="password" name="password" class="form-control" data-toggle="input-mask" placeholder="*************">
                                                </div>
                                            </div> <!-- end col -->
                                            <button style="margin-left: 500px;" type="submit" class="btn btn-outline-success waves-effect waves-light">Create</button>
                                        </form>
                                        </div>
                                        <!-- end row -->
