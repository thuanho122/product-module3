                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <form action="/admin?action=updatebakery" method="post">
                                                <input type="number" hidden name="id" class="form-control"
                                                       value="<c:out value='${bakery.id}'/>">
                                            <div class="form-group">
                                                <label>Bakery Name</label>
                                                <input type="text" name="bakeryName" class="form-control"
                                                       value="<c:out value='${bakery.bakeryName}'/>">
                                            </div>
                                            <div class="form-group">
                                                <label>Price</label>
                                                <input type="text" name="price" class="form-control"
                                                       value="<c:out value='${bakery.price}'/>">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="description" class="form-control"
                                                   value="<c:out value='${bakery.description}'/>">
                                        </div>

                                        <div class="form-group">
                                            <label>LogoPath</label>
                                            <input type="number" name="quantity" class="form-control"
                                                   value="<c:out value='${bakery.quantity}'/>">
                                        </div>

                                        <%-- <button style="margin-left: 500px;" type="submit" value="edit"--%>
                                        <%--  class="btn btn-outline-success waves-effect waves-light">Edit--%>
                                        <%-- </button>--%>
                                    </div> <!-- end col -->
