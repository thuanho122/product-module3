                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Form New Bakery</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Create New Bakery</h4>
                                        <p class="sub-header">
                                            Fill in the boxes below to create a new bakery
                                        </p>

                                        <div class="row">
                                            <div class="col-md-6">
                                                <form action="/admin?action=addnewbakery" method="post">
                                                    <div class="form-group">
                                                        <label>Bakery Name</label>
                                                        <input type="text" class="form-control" name="bakeryName" data-toggle="input-mask" placeholder="Bánh Sinh Nhật" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Price</label>
                                                        <input type="number" class="form-control" name="price" data-toggle="input-mask" placeholder="2000">
                                                    </div>
                                            </div> <!-- end col -->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Description</label>
                                                    <input type="text" class="form-control" name="description" data-toggle="input-mask" placeholder="ngon" >
                                                </div>
                                                <div class="form-group">
                                                    <label>Quantity</label>
                                                    <input type="number" min="1" class="form-control" name="quantity" data-toggle="input-mask" >
                                                </div>
