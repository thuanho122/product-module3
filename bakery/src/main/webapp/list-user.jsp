                                                ...
                                                <tr>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${user.status=='Active'}">
                                                            <td><a type="button" href="/admin?action=blockUser&id=${user.id}" class="btn btn-danger btn-rounded waves-effect waves-light">Block</a></td>
                                                        </c:when>
                                                        <c:when test="${user.status=='UnActive'}">
                                                            <td><a href="/admin?action=activeUser&id=${user.id}" type="button" class="btn btn-success btn-rounded waves-effect waves-light">Active</a></td>
                                                        </c:when>

                                                    </c:choose>
                                                    <td><a type="button" href="/admin?action=updateuser&id=${user.id}" class="btn btn-info btn-rounded waves-effect waves-light">Edit</a></td>
                                                </tr>
                                            </c:forEach>
...
<%--                                                <tr>--%>
<%--                                                    <td>5</td>--%>
<%--                                                    <td>Tran Quang Tien</td>--%>
<%--                                                    <td>tientran@gmail.com</td>--%>
<%--                                                    <td>0123456789</td>--%>
<%--                                                    <td>18</td>--%>
<%--                                                    <td>Quang Binh</td>--%>
<%--                                                    <td>Active</td>--%>
