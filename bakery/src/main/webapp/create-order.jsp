                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="sub-header">
                                    Fill in the boxes below to create a new order
                                </p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input type="text" min="18" class="form-control"
                                                   data-toggle="input-mask" placeholder="ngon">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <button style="margin-left: 490px;" type="submit"
                                            class="btn btn-outline-success waves-effect waves-light">Create
                                    </button>
                                    </form>
                                </div>
                                <!-- end row -->
